...
<?php if (of_get_option( 'magazine_logo' )): ?>
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo of_get_option( 'magazine_logo' ); ?>" alt="<?php bloginfo( 'name' ); ?>"/></a>
      			<?php else : ?>        
            <h1 class="site-title">
...
<div id="navigation" class="nav"> 
    <div id="navigation-inner" class="clearfix">
		<div class="secondary">		<?php		wp_nav_menu(array('container' => '', 'theme_location' => 'magazine-navigation', 'fallback_cb' => 'magazine_hdmenu'));			?>
